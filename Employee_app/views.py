...
def add_emp(request):
    if request.method == 'POST':
        #print("This is a sample msg",request)
       ...
       #role = int(request.POST['role'])
        ...
        if dept and role and salary and phone and first_name and last_name :
            ...
            return HttpResponse("Require to fill all the fields.")
